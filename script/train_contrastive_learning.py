...
if __name__ == '__main__':
    file_dir = '../checkpoints/retina_center'  # Path to store the saved model and other output files
    ...
    model_path = '../checkpoints/center_FER/best.pth'  # The path to the checkpoints
    best_acc = 0

    # Set transform for training and validation set
    ...
    optimizer_center = torch.optim.SGD(center_loss.parameters(), lr=model_lr)
