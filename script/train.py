...
if __name__ == '__main__':
    file_dir = '../checkpoints/retina_small'  # Path to store the saved model and other output files
    ...
    model_path = '../checkpoints/small_FER/best.pth'  # The path to the checkpoints
    best_acc = 0
