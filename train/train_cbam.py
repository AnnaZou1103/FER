...
from ema import EMA
from cbam_block import PatchMergingCBAM, PatchEmbedCBAM
...
if __name__ == '__main__':
    ...
    resume = False
    CLIP_GRAD = 5.0
    model_path = 'checkpoints_cbam_FER/best.pth'
    Best_ACC = 0
    use_ema = True
    ema_epoch = 32
    ...
    model_ft.patch_embed=PatchEmbedCBAM(model_ft.patch_embed)
